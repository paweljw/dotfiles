...
(doom! :input
       ...
       (unicode +emoji)           ; extended unicode support for various languages
       ...
       (org +pretty +dragndrop +jupyter +gnuplot +present +roam +habits)               ; organize your plain life in plain text
